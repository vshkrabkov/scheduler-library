...
func setupSnapshotTest(t *testing.T, ctx context.Context, nodes []*v1.Node, pods []*v1.Pod) (*ClusterSnapshot, *cache.Snapshot, *scheduler.Scheduler) {
	logger := klog.FromContext(ctx)
...
func simulateWorkload(ctx context.Context, logger klog.Logger, cs *ClusterSnapshot, sched *scheduler.Scheduler, workload Workload) (bool, error) {
